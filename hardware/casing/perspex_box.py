...
back_border=FingerJointBoxSide(centre, box_width, box_height, 'in', corners={'left':'off', 'top':'off', 'right':'off', 'bottom':'off'}, sidemodes={}, tab_length=tab_length, thickness=thickness, cutterrad=0, cutter=cutter, centred=True, fudge=fudge, auto=True)
...
bottom=module.add_path(Part(name='bottom', border=bottom_border,  layer='bottom'))
